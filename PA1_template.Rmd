...
By inspection, the plot seems to follow an approximate gaussian distribution centered at 10'000. Let's calculate the mean and median to confirm:
...
By inspection the maximum average number of steps seems to occur between the 500 and 1000 intervals. We can confirm this with the follow operations:
